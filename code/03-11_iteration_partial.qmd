...
healthy plant would have little reflectance on visible bands i think. green would be a little higher numbers since we see plants in green color 

healthy plants have higher NIR reflectance 
...
for (i in 3:ncol(nematode_w)) {
  ...
  #need the double brackets to make it a vector and not a data frame
